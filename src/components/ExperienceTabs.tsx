                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-x-4">
                    ...
                    <div className="shrink-0 text-left sm:max-w-[14rem] sm:text-right">
                      <p className="font-mono text-[10px] uppercase leading-4 tracking-[0.08em] text-zinc-500">
                        {item.period}
                      </p>
                      {location && (
                        <p className="mt-1.5 text-[13px] font-medium leading-4 text-zinc-300 sm:ml-auto">
                          {location}
                        </p>
                      )}
                    </div>
